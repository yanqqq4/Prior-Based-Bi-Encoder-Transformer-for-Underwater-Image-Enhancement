...
class Main(nn.Module):
	...
	def forward_features(self, x,p):
		...
		# enchanced = self.enchconv(skip1, skip2)
		enchanced_skip2 = self.fusion1([enchanced, skip2])
		# enchanced_skip2 = torch.cat([skip2, p1], 1)
		# enchanced_skip2 = self.down2_1(enchanced_skip2)
		...
		# enchanced_skip1 = torch.cat([skip1, p0], 1)
		# enchanced_skip1 = self.down1_1(enchanced_skip1)
	...
	def forward(self, x, p):
		...
		# feat, T_OUT = self.forward_features(x)
		#print(feat.shape)
